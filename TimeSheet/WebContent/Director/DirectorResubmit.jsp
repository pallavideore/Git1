...
<a class="active" href="${pageContext.request.contextPath}/UserDashboard">Home</a></li>
 ...
 <li><a href="${pageContext.request.contextPath}/Director/DirectorReport.jsp">Report</a></li>
...
<tr><td style="width:70px"><b>Date:</b></td><td style="width:80px"><input type="text" name="startdate" id="startdate" value="<%=request.getAttribute("startdate") %>" placeholder="  mm/dd/yy" readonly="readonly" style="width:130px";/>
 

<td border="0" align="center" style="width:50px"><span><input  type="submit" name="show" value="View" onclick="form.action='<%=request.getContextPath()%>/DirectorResubmitTask';"></span></td>
       ...
       <td><b>Edit</b></td> 
            ...
            %>
             <tr style="background-color:<%=color%>;">
                ...
                <td><%=pList.get(7)%></td>
                  <td><%=pList.get(8)%></td>
<td><a  href="<%=request.getContextPath()%>/DirectorUpdateTask?taskid=<%=pList.get(0)%>&status=Reupdate"><input type="button" value="Update" style="margin-left: 0%;width:80px;height:32px;background-color:#007BC0;color:white" /></a></td>
           <td><a href="<%=request.getContextPath()%>/DirectorDeleteTask2?taskid=<%=pList.get(0)%>&date=<%=pList.get(2)%>"><input type="button" name= "Delete" value="Delete" style="margin-left: 0%;width:80px;height:32px;background-color:#007BC0;color:white" onclick="if (confirm('Are you sure you want to delete?')){form.action='<%=request.getContextPath()%>/DirectorDeleteTask2'}else { return false; };" /></a></td>
    ...
    <input type="submit" name= "Reject" id="submitt" value="Resubmit" style="margin-left: 0%;width:80px;height:32px;background-color:#007BC0;color:white" onclick="form.action='<%=request.getContextPath()%>/DirSendMailApproval';return validation2(this)"/>
