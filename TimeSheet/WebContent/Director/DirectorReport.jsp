...
<% while(resultset3.next()){ %>
    ...
    <table border="1" bordercolor="#C0C0C0" cellspacing="2" cellpadding="2" width="55%" align="center" >
      <tr><td ><b>Start Date:</b></td><td><input type="text" id="startdate" placeholder="mm/dd/yy" style="width:200px" readonly="readonly" required name="startdate"/>
 <td ><b>End Date:</b></td><td><input type="text" id="enddate"  placeholder="mm/dd/yy" style="width:200px" readonly="readonly"  required name="enddate"/></td>
