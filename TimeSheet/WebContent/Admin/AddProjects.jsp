...
%>
      ...
      <tr bordercolor=" #C0C0C0"><td ><b>Planned Start Date:<span class="required">*</span></b></td><td><input type="text" name="StartDate" id="startdate" placeholder="mm/dd/yyyy" style="width:190px" readonly="readonly"  required name="title";/>
 <tr bordercolor=" #C0C0C0"> <td><b>Planned End Date:<span class="required">*</span></b></td><td><input type="text" name="EndDate" id="enddate" placeholder="mm/dd/yyyy" style="width:190px" readonly="readonly"  required name="title";/>
<script>
