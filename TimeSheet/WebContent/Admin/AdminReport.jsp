...
<% while(resultset2.next()){ %>
 ...
 <div id="f3" style="height:200px;width:350px;display: none" class="scrollbar">
    ...
    <table border="1" bordercolor="#C0C0C0" cellspacing="2" cellpadding="2" width="55%" align="center" >
      ...
      <tr><td ><b>Start Date:</b></td><td><input type="text" id="startdate" name="startdate" placeholder="dd/mm/yy"  style="width:200px" readonly="readonly" required name="title";/>
 <td ><b>End Date:</b></td><td><input type="text" id="enddate" name="enddate" placeholder="dd/mm/yy" style="width:200px" readonly="readonly" required name="title";/></td>
