...
<td border="0" align="center" style="width:50px"><span><input  type="submit" name="show" value="View" onclick="form.action='<%=request.getContextPath()%>/ManagerResubmitTask';"></span></td>
       ...
       <td><b>Delete</b></td> 
            ...
            %>
             <tr style="background-color:<%=color%>;">
                ...
                <td><%=pList.get(7)%></td>
                  <td><%=pList.get(8)%></td>
<td><a href="<%=request.getContextPath()%>/ManagerUpdateTask2?taskid=<%=pList.get(0)%>"><input type="button" value="Update" style="margin-left: 0%;width:80px;height:32px;background-color:#007BC0;color:white" /></a></td>
 <td><a href="<%=request.getContextPath()%>/ManagerDeleteTask2?taskid=<%=pList.get(0)%>&date=<%=pList.get(2)%>"><input type="button" name= "Delete" value="Delete" style="margin-left: 0%;width:80px;height:32px;background-color:#007BC0;color:white" onclick="if (confirm('Are you sure you want to delete?')){form.action='<%=request.getContextPath()%>/ManagerDeleteTask2'}else { return false; };" /></a></td>
    ...
    <br><br>
    	...
    	<input type="submit" name= "Reject" id="submitt" value="Resubmit" style="margin-left: 0%;width:80px;height:32px;background-color:#007BC0;color:white" onclick="form.action='<%=request.getContextPath()%>/MngSendMailApproval';return validation2(this)"/>
