...
<a class="active" href="${pageContext.request.contextPath}/ManagerDashboard">Home</a></li>
 ...
 <li style="float:right"><a href="<%=request.getContextPath()%>/LogoutServlet">Logout</a></li>
           ...
           <span style=" margin-left:5px;margin-top:80px;width:222px;fontfamily:Calibri;color:#007BC0;bordercolor:rgb(211,211,211)">Date:</span> <input type="text" id="startdate" value="<%=request.getAttribute("date")%>" name="date"  readonly="readonly" required name="title"/>
