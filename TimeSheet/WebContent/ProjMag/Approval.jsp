...
<article>
 <br>
    <form name="form" id="formtest"  method="post">
      ...
      <tr><td ><b>Start Date:</b></td><td><input type="text" id="startdate" name="startdate" placeholder="dd/mm/yy"  style="width:200px" value="<%=request.getAttribute("startdate") %>"  readonly="readonly" required name="title";/>
 <td ><b>End Date:</b></td><td><input type="text" id="enddate" name="enddate" placeholder="dd/mm/yy" style="width:200px" value="<%=request.getAttribute("enddate") %>"  readonly="readonly" required name="title";/></td>
